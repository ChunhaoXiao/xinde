...
<div class="box">
    <div class="box-header">
        ...
        <form method="post" action="{{isset($data)?route('admin.advertisement.update', $data) : route('admin.advertisement.store')}}"  enctype="multipart/form-data">
            ...
            <x-textinput name="start_time" type="date" label="开始时间" :value="isset($data)?$data->start_time->toDateString():''"/>
            <x-textinput name="end_time" type="date" label="结束时间" :value="isset($data)?$data->end_time->toDateString():''"/>
