...
! function(e, t) {
	...
	$e.LinkRegExCommon = "[".concat("a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_\\.", "]{1,}"), $e.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;\\/~+#-\\'*-_{}]*)|())", $e.LinkRegExTLD = "((".concat($e.LinkRegExCommon, ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))"), $e.LinkRegExHTTP = "((ftp|http|https):\\/\\/".concat($e.LinkRegExCommon, ")"), $e.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@".concat($e.LinkRegExCommon, ")"), $e.LinkRegExWWW = "(www\\.".concat($e.LinkRegExCommon, "\\.[a-z0-9-]{2,24})"), $e.LinkRegEx = "(".concat($e.LinkRegExTLD, "|").concat($e.LinkRegExHTTP, "|").concat($e.LinkRegExWWW, "|").concat($e.LinkRegExAuth, ")").concat($e.LinkRegExEnd), $e.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], $e.MAIL_REGEX = /.+@.+\..+/i, $e.MODULES.helpers = function(o) {
		...
		function E(e) {
			...
			var n, a, r = t ? (t.textContent.match(/\u200B/g) || []).length - t.querySelectorAll(".fr-marker").length : 0;
		...
		return {
			...
			get: function D(e, t) {
				...
				} else n = O.$el.html(); if (!O.opts.useClasses && !t)
		...
		return {
			_init: function u() {
				L.el.addEventListener("copy", e), L.el.addEventListener("cut", e), L.el.addEventListener("paste", t, {
					capture: !0
				}), L.events.on("drop", a), L.browser.msie && L.browser.version < 11 && (L.events.on("mouseup", function(e) {
	...
	if (E.Bootstrap = function(e, t, n) {
		...
		function i() {
			if (n.opts.charCounterCount) {
				...
				a.text("".concat(n.language.translate("Characters"), " : ").concat(e)), n.opts.toolbarBottom && a.css("margin-bottom", n.$tb.outerHeight(!0));
		...
		function r(e) {
			...
			if (t.length) {
				...
				else d.$el.find(".fr-marker").replaceWith($e.MARKERS), d.selection.restore(); if (n === d || d.undo.canDo() || d.undo.saveStep(), d.core.isEmpty()) d.$el.html(r);
				else {
		...
		editInPopup: !1
	}), $e.MODULES.editInPopup = function(a) {
		function e() {
		...
		function se(e) {
			if (e && e.clipboardData && e.clipboardData.items) {
				...
				if (e.clipboardData.types && -1 != [].indexOf.call(e.clipboardData.types, "text/rtf") || e.clipboardData.getData("text/rtf")) t = e.clipboardData.items[0].getAsFile();
					...
					for (var n = 0; n < e.clipboardData.items.length && !(t = e.clipboardData.items[n].getAsFile()); n++); if (t) return function a(e) {
		...
		return {
			...
			toggleCaption: function Be() {
				...
				if (p && !Ae()) {
					...
					var t, n, a = p.parents("ul") && 0 < p.parents("ul").length ? p.parents("ul") : p.parents("ol") && 0 < p.parents("ol").length ? p.parents("ol") : [];
					if (0 < a.length) {
	...
	return $e.DEFAULTS.imageInsertButtons.push("imageManager"), $e.RegisterCommand("imageManager", {
		...
		function r(e) {
			s || function t() {
				i.shared.$quick_insert || (i.shared.$quick_insert = c(document.createElement("div")).attr("class", "fr-quick-insert").html('<a class="fr-floating-btn" role="button" tabIndex="-1" title="'.concat(i.language.translate("Quick Insert"), '">').concat(i.icon.create("quickInsert"), "</a>")));
				s = i.shared.$quick_insert, i.tooltip.bind(i.$box, ".fr-quick-insert > a.fr-floating-btn"), i.events.on("destroy", function() {
					c("body").first().append(s.removeClass("fr-on")), l && (f(), c("body").first().append(l.css("left", -9999).css("top", -9999)))
		...
		return {
			...
			insert: function ne(e, t) {
				var n, a, r = "<table " + (C.opts.tableDefaultWidth ? 'style="width: ' + C.opts.tableDefaultWidth + ';" ' : "") + 'class="fr-inserted-table"><tbody>',
					o = 100 / t;
				for (n = 0; n < e; n++) {
			...
			splitCellHorizontally: function le() {
				if (1 == Q().length) {
					...
					if (1 < a) {
						...
						for (var l = o.row + s, c = 0 === o.col ? o.col : o.col - 1; 0 <= c && (r[l][c] == r[l][c - 1] || 0 < l && r[l][c] == r[l - 1][c]);) c--; - 1 == c ? R(n.find("tr").not(n.find("> table tr")).get(l)).prepend(i) : R(r[l][c])[0].parentNode && R(r[l][c])[0].insertAdjacentElement("afterend", i[0])
					} else {
		...
		function Z(e, t, n) {
			!u.opts.htmlUntouched && u.opts.useClasses ? (e.removeClass("fr-fvl fr-fvr fr-dvb fr-dvi"), e.addClass("fr-fv".concat(n[0], " fr-dv").concat(t[0]))) : "inline" == t ? (e.css({
				display: "inline-block"
			}), "center" == n ? e.css({
				"float": "none"
			}) : "left" == n ? e.css({
		...
		function g(e, t) {
			if (t) {
				...
				} else n = e.parentNode.getAttribute("o:spid"); if (e.removeAttribute("height"), n) {
					! function s(e) {
		...
		function m(e, t) {
			...
			if ("TR" === n && function T(e, t) {
				...
				for (var n = e.firstElementChild, a = 0, r = !1, o = null; n;) {
					...
					for (var i = n.firstElementChild, s = 1 === n.children.length; i;) "P" !== i.tagName || O(i) || s && S(i), i = i.nextElementSibling;
					if (t) {
				...
				if (e.nodeType === Node.ELEMENT_NODE) {
					if (O(e)) {
						var t = e.parentNode,
							n = e.previousSibling,
							a = function _(e, t, n) {
								var a, r, o, i = /[0-9a-zA-Z]./gi,
									s = !1,
									l = navigator.userAgent.toLowerCase(); - 1 != l.indexOf("safari") && (l = -1 < l.indexOf("chrome") ? 1 : "safari"), e.innerHTML.includes("mso-list:\nIgnore") && (e.innerHTML = e.innerHTML.replace(/mso-list:\nIgnore/gi, "mso-list:Ignore"));
								...
								for (var y = !1; e;) {
									...
									var R = N(e);
									if ((n = n || R) < R) g += (d = _(e, t, R)).el.outerHTML, e = d.currentNode;
									else {
										if (R < n) break;
										e.firstElementChild && e.firstElementChild.firstElementChild && e.firstElementChild.firstElementChild.firstChild && (i.lastIndex = 0, a = i.test(e.firstElementChild.firstElementChild.firstChild.data || e.firstElementChild.firstElementChild.firstChild.firstChild && e.firstElementChild.firstElementChild.firstChild.firstChild.data || "")), o && o.firstElementChild && o.firstElementChild.firstElementChild && o.firstElementChild.firstElementChild.firstChild && (i.lastIndex = 0, r = i.test(o.firstElementChild.firstElementChild.firstChild.data || o.firstElementChild.firstElementChild.firstChild.firstChild && o.firstElementChild.firstElementChild.firstChild.firstChild.data || "")), r === undefined || r === a && ("ul" === f || "list-style-type: undefined" !== p && "list-style-type: circle;" === p) && 1 != R || r === a && "ol" === f && "list-style-type: undefined" !== p && "list-style-type: circle;" !== p ? (c = x(e, t), e.nextSibling.innerText == undefined || e.nextSibling.innerText == undefined || g.includes('class="decimal_type"') || isNaN(parseInt(e.nextSibling.innerText.trim().split(".")[1], 10)) || (g = g.substring(3, 0) + ' class="decimal_type"' + g.substring(3, g.length)), g += "<li>" + c + "</li>") : (1 == R && (g += "</" + f + ">", y = !0, o = null), g += (d = _(e, t, R)).el.outerHTML, e = d.currentNode);
										var L = e && e.nextElementSibling;
										L && (o = L.previousElementSibling), e && e.parentNode && e.parentNode.removeChild(e), e = L
									}
								}
								y || (g += "</" + f + ">");
								var w = document.createElement("div");
								return w.innerHTML = g, {
									el: w,
									currentNode: e
								}
							}(e, s).el,
